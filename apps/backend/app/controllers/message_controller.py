...
class MessageController(metaclass=SingletonMeta):
    '''
    メッセージ情報コントローラークラス
    '''
    _instance = None
    ...
    def __new__(cls, *args, **kwargs):
        '''
        シングルトンインスタンスを生成する
        :return: MessageController: メッセージ情報コントローラー
        '''
        if cls._instance is None:
            cls._instance = super(MessageController, cls).__new__(cls, *args, **kwargs)
